...
class Ui_newRecipe(object):
    def setupUi(self, newRecipe):
        ...
        self.pushButton = QtWidgets.QPushButton(newRecipe)
        ...
        self.gridLayout.addWidget(self.doneButton, 5, 2, 1, 1)
    ...
    def retranslateUi(self, newRecipe):
        ...
        self.pushButton.setText(_translate("newRecipe", "Add Recipe Notes"))
